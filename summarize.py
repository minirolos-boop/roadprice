# summarize.py — Génère docs/index.md à partir de data/weroad.db (run_ts)
...
def html_table(df: pd.DataFrame, max_rows: int = 20) -> str:
    """Table HTML fiable, avec gestion précise des % et €. """
...
def main():
    ...
    try:
        ...
        # Mensuel (calculé sur snapshot courant)
